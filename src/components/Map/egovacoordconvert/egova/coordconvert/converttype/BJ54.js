...
class BJ54 extends Base{
    constructor(params) {
        super(params);
        this.param4 = new Param4(0,params);
    }
...
if(!CoordConvertFactory[CoordConvertType.FOUR_BJ54]){
    CoordConvertFactory[CoordConvertType.FOUR_BJ54] = BJ54;
}
export default BJ54;